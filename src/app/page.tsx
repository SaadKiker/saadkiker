...
export default function Home() {
  return (
    <div className="h-[100dvh] flex flex-col overflow-hidden" style={{ backgroundColor: "#F5F5F0" }}>
      ...
      <main className="flex-1 flex flex-col md:flex-row items-center justify-center px-6 md:px-8 gap-4 md:gap-12 overflow-hidden">
        ...
        <div className="max-w-xl text-center md:text-left">
          <h1 className="text-3xl md:text-7xl font-bold mb-1 md:mb-3 leading-tight" style={{ color: "#1C1C1A" }}>
            Hey, I&apos;m Saad.
          </h1>
          <p className="text-sm md:text-2xl leading-relaxed mb-1 md:mb-4" style={{ color: "#5A5A56" }}>
            I&apos;m a full-stack engineer from Morocco, specializing in React, Next.js, and TypeScript.
          </p>
          <p className="text-sm md:text-2xl leading-relaxed mb-4 md:mb-8" style={{ color: "#5A5A56" }}>
            Glad you&apos;re here! Have a look around.
          </p>

          <div className="inline-block text-left">
            <p className="text-xs md:text-sm font-semibold uppercase tracking-widest mb-1.5 md:mb-3" style={{ color: "#9A9A96" }}>
              Currently
            </p>
            <div className="space-y-1 md:space-y-2 text-sm md:text-base" style={{ borderLeft: "2px solid #DEDEDB", paddingLeft: "1rem" }}>
              <p>
                <span className="font-semibold" style={{ color: "#1C1C1A" }}>building</span>
                <span className="mx-2" style={{ color: "#DEDEDB" }}>—</span>
                <a href="https://scanini.ma" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:opacity-60 transition-opacity" style={{ color: "#5A5A56" }}>scanini.ma</a>
              </p>
              <p>
                <span className="font-semibold" style={{ color: "#1C1C1A" }}>reading</span>
                <span className="mx-2" style={{ color: "#DEDEDB" }}>—</span>
                <span style={{ color: "#5A5A56" }}>$100M Leads — Alex Hormozi</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="flex justify-center items-center gap-6 md:gap-8 py-2 md:py-5">
        {/* GitHub */}
        <a href="https://github.com/SaadKiker" target="_blank" rel="noopener noreferrer" className="hover:opacity-40 transition-opacity" style={{ color: "#9A9A96" }}>
        ...
        {/* LinkedIn */}
        <a href="https://www.linkedin.com/in/saadkiker" target="_blank" rel="noopener noreferrer" className="hover:opacity-40 transition-opacity" style={{ color: "#9A9A96" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* Email */}
        <a href="mailto:saadkiker.k@gmail.com" className="hover:opacity-40 transition-opacity" style={{ color: "#9A9A96" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {/* WhatsApp */}
        <a href="https://wa.me/212623122381" target="_blank" rel="noopener noreferrer" className="hover:opacity-40 transition-opacity" style={{ color: "#9A9A96" }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
